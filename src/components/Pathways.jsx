...
export default function Pathways() {
    return (
        <section id="pathways" className="relative min-h-screen bg-[#020b06] flex flex-col pt-20 sm:pt-32 pb-24 sm:pb-48 px-4 sm:px-6 lg:px-12 xl:px-24 overflow-hidden z-10">
